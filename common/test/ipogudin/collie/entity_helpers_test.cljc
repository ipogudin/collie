(ns ipogudin.collie.entity-helpers-test
  (:require [#?(:clj clojure.test
            ...
            [ipogudin.collie.entity-helpers :refer [set-field-value create-empty-entity]]))
  ...
  (testing "Helper functions"
    (testing "Setting field"
      (testing "Updating field with direct value"
        (let [a {:id 1 :name "A" :value1 5 ::e/type :a}
      ...
      (testing "Updating one-to-one relation field"
        (let [a {:id 1 :name "A" :value1 5 :b 1 ::e/type :a :deps {:b {:id 1 :name "B" ::e/type :b}}}
      ...
      (testing "Updating many-to-many relation field"
        (let [a {:id 1
          ...
          (is (= (assoc-in a [:deps :d_entities] new-value)
                 (set-field-value schema-map field-for-update a new-value))))))
    (testing "Creation of empty entity"
      (let [entity-schema (:a schema-map)
            new-entity (create-empty-entity :a entity-schema)
            expected-result {::entity/type :a
                             :name "default name"
                             :value1 1
                             :value2 0
                             :deps {:b {}
