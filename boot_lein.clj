...
; This is a fork of boot.lein https://github.com/onetom/boot-lein-generate
; The code was extended, see comments below
             ...
             head (list* 'defproject (or project 'boot-project) (or version "0.0.0-SNAPSHOT")
                         (concat
                           ...
                           [:repositories (core/get-env :repositories)
                            ...
                            ;added test-paths which is not standard for boot
                            :test-paths (into [] (core/get-env :test-paths))
